...
module.exports = class extends Command {
	...
	async run (message, [userOrChannel]) {
		const items = [...await this.client.utils.get_instances(message, userOrChannel, { search_blocked: true, show_hidden: false, get_types: ['channels'], guild_only: ['channels'], channel_types: ['text'] } )];
