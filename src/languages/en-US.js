...
module.exports = class extends Language {
	constructor (...args) {
		...
		this.language = {
			...
			RESOLVER_INVALID_CATEGORY: (name) => `${name} must be a channel category or valid category id.`,
			...
			COMMAND_REGEX_ADD_EXTENDED: [
				"This command allows you to add any regex you want to your list",//, with a cap of 20 total regexes.",
