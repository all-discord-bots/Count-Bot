...
const ChannelGateway = require('./settings/GatewayTextChannel');
...
module.exports = class extends Client {
	...
	static [Client.plugin]() {
		...
		this.gateways.channels = new ChannelGateway(this.gateways, 'channels', channelSchema, channels.provider || this.options.providers.default);
